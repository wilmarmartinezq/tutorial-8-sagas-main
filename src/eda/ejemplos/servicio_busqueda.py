from eda.modulos.ordenes.dominio.objetos_valor import Odo, ParametroBusca, Segmento, Leg, CodigoIATA, Itinerario
from eda.modulos.ordenes.dominio.entidades import Proveedor,Aeropuerto
