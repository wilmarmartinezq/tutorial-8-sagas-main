...
def registrar_handlers():
    import eda.modulos.ordenes.aplicacion

def importar_modelos_alchemy():
    import eda.modulos.adquisiciones.infraestructura.dto
...
def create_app(configuracion={}):
    ...
    app.config['TESTING'] = configuracion.get('TESTING')
     ...
     # Inicializa la DB
    from eda.config.db import init_db, database_connection
    ...
    with app.app_context():
        ...
        from eda.modulos.sagas.aplicacion.coordinadores.saga_ordenes import CoordinadorOrdenes
        CoordinadorOrdenes()
